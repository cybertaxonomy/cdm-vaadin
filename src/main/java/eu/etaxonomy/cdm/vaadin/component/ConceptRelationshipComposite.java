...
public class ConceptRelationshipComposite extends CustomComponent implements ISelectionListener, ICdmChangeListener, IBasicEventListener {
    ...
    private IConceptRelationshipComponentListener listener;
    ...
    @Autowired
    public void setPresenter(ConceptRelationshipPresenter presenter){
        this.crp = presenter;
        crp.setTree(d3ConceptRelationShipTree);
        listener = crp;
    }
