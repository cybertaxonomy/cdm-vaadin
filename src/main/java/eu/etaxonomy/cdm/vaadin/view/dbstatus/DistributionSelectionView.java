...
public class DistributionSelectionView extends CustomComponent implements IDistributionSelectionComponent, View, ClickListener{
	...
	public void buttonClick(ClickEvent event) {
		if(classificationBox != null && distributionAreaBox != null){
			TaxonNode taxonNode = (TaxonNode) classificationBox.getValue();
			TermVocabulary<DefinedTermBase> term = (TermVocabulary<DefinedTermBase>)distributionAreaBox.getValue();
			try {
				distListener.buttonClick(null, term, taxonNode);
	...
	public void dataBinding(){
		...
		List<TaxonNodeProperty> allNodes = new ArrayList<TaxonNodeProperty>();
		for (Classification classification : classificationList) {
		    ...
		    for (TaxonNode taxonNode : allNodesForClassification) {
		        allNodes.add(new TaxonNodeProperty(taxonNode));
            }
		}
		Container c = new IndexedContainer(allNodes);
		c.addContainerProperty("TaxonNode", TaxonNodeProperty.class, null);
	...
	class TaxonNodeProperty implements Property<TaxonNode> {

	    private TaxonNode taxonNode;

        public TaxonNodeProperty(TaxonNode taxonNode) {
            this.taxonNode = taxonNode;
        }

        @Override
        public TaxonNode getValue() {
            return taxonNode;
        }

        @Override
        public void setValue(TaxonNode newValue) throws com.vaadin.data.Property.ReadOnlyException {
            this.taxonNode = newValue;
        }
        ...
        @Override
        public Class<? extends TaxonNode> getType() {
