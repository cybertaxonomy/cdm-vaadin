 ...
 * @since Jan 26, 2018
 */
public interface NameTypeDesignationEditorView
        extends ApplicationView<NameTypeDesignationEditorView,NameTypeDesignationPresenter>, AnnotationsEditor, NomenclaturalActContext  {
